...
def parse_args(config_path=None):
    ...
    parser.add("--mean_trans_path", default="", type=str)
    parser.add("--std_trans_path", default="", type=str)
    ...
    parser.add("--vqvae_lower_trans_path", default="", type=str)
    parser.add("--use_trans", default=False, type=str2bool)
    parser.add("--use_motionclip", default=False, type=str2bool)
