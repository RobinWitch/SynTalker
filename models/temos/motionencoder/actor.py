...
import sys
sys.path.append('/mnt/data3/cbh/PantoMatrix/scripts/EMAGE_2024/models/')
from temos.operator import PositionalEncoding
from temos.utils.temos_utils import lengths_to_mask
...
class ActorAgnosticEncoder(pl.LightningModule):
    ...
    def forward(self, features: Tensor, lengths: Optional[List[int]] = None,max_len =None) -> Union[Tensor, Distribution]:
        if lengths is None:
        ...
        mask = lengths_to_mask(lengths, device,max_len)
